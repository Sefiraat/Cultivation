package dev.sefiraat.botanystory.api.slimefun.items;

import com.google.common.base.Preconditions;
import dev.sefiraat.botanystory.Registry;
import dev.sefiraat.botanystory.api.events.PlantGrowEvent;
import dev.sefiraat.botanystory.api.interfaces.BotanyPlant;
...
import dev.sefiraat.botanystory.api.slimefun.groups.BotanyGroups;
...
import dev.sefiraat.botanystory.api.slimefun.plant.Growth;
import dev.sefiraat.botanystory.api.slimefun.plant.GrowthStages;
import dev.sefiraat.botanystory.api.slimefun.plant.SeedSkin;
import dev.sefiraat.botanystory.api.utils.LevelType;
import dev.sefiraat.botanystory.api.utils.StatisticUtils;
...
public abstract class BotanySeed extends SlimefunItem implements BotanyPlant, CustomPlacementBlock {
    ...
    protected BotanySeed(SlimefunItemStack item, Growth growth) {
        this(item, RecipeTypes.PLANT_BREEDING, new ItemStack[0], growth);
    }

    @ParametersAreNonnullByDefault
    protected BotanySeed(SlimefunItemStack item,
    ...
    protected BotanySeed(SlimefunItemStack item,
        ...
        super(BotanyGroups.SEEDS, item, recipeType, recipe, recipeOutput);
        this.growth = growth;
    }
        ...
        addItemHandler(
            new BlockTicker() {
                ...
                public void tick(Block block, SlimefunItem item, Config data) {
                    if (item instanceof BotanySeed seed) {
    ...
    @ParametersAreNonnullByDefault
    private void onTick(Block block, BotanySeed seed, Config data) {
    ...
    @ParametersAreNonnullByDefault
    private void tryGrow(Block block, BotanySeed seed, Config data, Location location, int growthStage) {
    ...
    @ParametersAreNonnullByDefault
    private void trySetChildSeed(Location motherLocation, Block cloneBlock, BotanySeed childSeed) {
     ...
     */
    @Nonnull
    public BotanySeed setGrowth(@Nonnull Growth growth) {
        this.growth = growth;
    ...
    @Nonnull
    @ParametersAreNonnullByDefault
    public BotanySeed addBreedingPair(String mother, String father, double breedChance, double spreadChance) {
